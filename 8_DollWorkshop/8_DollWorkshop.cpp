...
void mouseCallack1(ObjectID obj, int x, int y, MouseAction act) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            if (obj == Fabrics[i]) { //천 중 하나를 선택했을 때
                ...
                if (selectedF) { //하나를 선택한 상태에서
                    ...
                    SoundID sci1 = createSound("audios/scissor.mp3");
                    playSound(sci1, false);
            ...
            if (obj == Special1[i]) { //부자재1 중 하나를 선택했을 때
                ...
                if (selectedS1) { //하나를 선택한 상태에서
                    ...
                    SoundID sew1 = createSound("audios/sewing.mp3");
                    playSound(sew1, false);
            ...
            if (obj == Special2[i]) { //부자재2 중 하나를 선택했을 때
                ...
                SoundID deco1 = createSound("audios/deco.mp3");
                playSound(deco1, false);
    ...
    if (obj == Startbutton) {
        ...
        //게임 타이머 생성
        gamemainTimer = createTimer(300.0f);
